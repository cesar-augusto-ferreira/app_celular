...
class TelaQuemSomo extends StatefulWidget {
  const TelaQuemSomo({Key? key}) : super(key: key);

  @override
  State<TelaQuemSomo> createState() => _TelaQuemSomoState();
}

class _TelaQuemSomoState extends State<TelaQuemSomo> {
  @override
