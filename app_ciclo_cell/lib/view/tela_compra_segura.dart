...
class TelaCompraSegura extends StatefulWidget {
  const TelaCompraSegura({Key? key}) : super(key: key);

  @override
  State<TelaCompraSegura> createState() => _TelaCompraSeguraState();
}

class _TelaCompraSeguraState extends State<TelaCompraSegura> {
  @override
